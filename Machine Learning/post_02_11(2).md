...
>>*operates over each activation map independently
  ...
  * Pooling시 기본적으로 겹치지 않게 하는 것이 일반적
  (Downsampling이 목적이기 때문에)
  * Q: Max Pooling이 Average Pooling보다 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEwNjk4OTIxMCwtMTA2ODA5NjI2NSwxMD
YxODYwNzksODA3MjMyNTI5LDE2MDAzNTAxMzYsNzE5NTEwNjc0
LDg0NzIzNDQzMCwtMjEwNTUzNDQwMSwtODE0MTM2ODI2LDIxMj
c5MzAwMzZdfQ==
-->