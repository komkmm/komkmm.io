...
## Batch Normalization
> layer를 거치면서 data의 분포 변화가 심해져서 학습이 어려워짐. layer -> Batch Normalization -> Activation 순으로 조정
* Improves gradient flow through the network 
* Allows higher 
* Regularization의 역할도 수행
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDM5MzY3MjIxLC0yOTQ5MzM4MTMsLTIxMj
gyMzE3MzIsLTE4ODM1NTg0MjgsMjA5ODMxMzkyNCw1OTMyODcz
OTksLTIwOTcwMDgxMzQsLTUzNzM5MTU2MV19
-->