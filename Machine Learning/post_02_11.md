...
> layer를 거치면서 data의 분포 변화가 심해져서 학습이 어려워짐. 강제로 unit gaussian으로 조정. layer -> Batch Normalization -> Activation 순으로 조정
* Improves gradient flow through the network 
* Allows higher learning rates
* Reduces the strong dependence on initialization
* Acts as a form of regularization in a funny way, and slightly reduces the need for dropout, maybe

Q. 강제로 gaussian으로 조정하면 원래의 구조
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkzOTM0NzcyNSwxNTE4NzExMDE1LC0yOT
Q5MzM4MTMsLTIxMjgyMzE3MzIsLTE4ODM1NTg0MjgsMjA5ODMx
MzkyNCw1OTMyODczOTksLTIwOTcwMDgxMzQsLTUzNzM5MTU2MV
19
-->